<head>
    ...
    <style>
        body {
            font-family: 'Nunito';
            background-image: url("https://i.pinimg.com/originals/96/97/45/9697454708c8c4d26a5acee8e26a78ed.png")
        }
    </style>
</head>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 hero-text">
                        ...
                        <h5 style="text-align: justify;">Sistema de Investimento - entre ou registre-se para ter acesso
                            as informações.</h5>
                    </div>
                    <div class="col-md-6">
